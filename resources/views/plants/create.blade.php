    ...
    <div class="max-w-[50%] mx-auto">
        <form action="/plants" method="POST">
                ...
                <div class="mt-1">
                    <div
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="Cactus" value="{{ old('title') }}" required>
                    </div>
                ...
                <div class="mt-1">
                    <div
                        ...
                        <textarea type="text" name="description" id="description"
                            class="block min-w-0 grow py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6"
                            rows="5" placeholder="Lorem ipsum dolor sit amet..." required>{{ old('description') }}</textarea>
                    </div>
                ...
                <div class="mt-1">
                    <div
                        ...
                        <input type="number" name="price" id="price"
                            class="block min-w-0 grow py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6"
                            placeholder="100" value="{{ old('price') }}" required>
                    </div>
                ...
                <div class="mt-1">
                    <div
                        ...
                        <input type="text" name="img" id="img"
                            class="block min-w-0 grow py-1.5 pl-1 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6"
                            placeholder="https://whateveruwant.com" value="{{ old('img') }}" required>
                    </div>
            ...
            <div class="flex justify-end">
                <button type="submit"
                    class="rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add
                    plant
                </button>
            </div>
        </form>
